...
#if defined(NDEBUG)
# error "2x2Coin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "2x2Coin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // 2x2Coin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // 2x2Coin also requires low S in sigs
